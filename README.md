...
- a summary describing the regex featured in the tutorial (you also need to include code snippet examples when necessary)
...
THEN I am taken to the corresponding sections of the tutorial (menu needs to work)
